...
public class ActionItems_GUI extends javax.swing.JFrame {
    ...
    private void CreateButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        // this.tasks.add(task);
         ...
         row[0] = ActionsItem.get(i).getName();
         row[1] = ActionsItem.get(i).getDescription();
         row[2] = ActionsItem.get(i).getTodayDate();
         row[3] = ActionsItem.get(i).getResource();
         row[4] = ActionsItem.get(i).getExpectedCompletionDate();
         row[5] = ActionsItem.get(i).getStatus();
         row[6] = ActionsItem.get(i).getStatusDescription();
         row[7] = ActionsItem.get(i).getUpdateDate();
    ...
    public static String[] inputAdd() {
	      ...
	      JTextField descriptionTemp = new JTextField(5);
	      JTextField todayDateTemp = new JTextField(5);
	      JTextField resourceTemp = new JTextField(5);
        JTextField dateAssignedTemp = new JTextField(5);
        JTextField expectionTemp= new JTextField(10);
        JTextField actualDateTemp = new JTextField(5);
	      JTextField statusTemp = new JTextField(5);
	      JTextField sDescriptionTemp = new JTextField(5);
	      JTextField updateDateTemp = new JTextField(5);
	    ...
	    //Input message with the textfields
          ...
          String dateAssigned = dateAssignedTemp.getText();
	    	 ...
	    	 // String assignedDate  = endTemp.getText();
